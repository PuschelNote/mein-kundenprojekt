...
export default async function OeffnungszeitenPage() {
  ...
  return <main className="admin-page"><header className="page-header"><div><h1>Feiertagsöffnungen</h1><p>Abweichende Öffnungszeiten oder Schließtage je Standort festlegen. Ohne Eintrag gelten automatisch die Standardzeiten.</p></div></header>
